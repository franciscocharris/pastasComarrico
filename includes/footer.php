  <!-- FOOTER -->
  <footer class=" mt-5 primer_footer">
    <div class="container">
      <div class="row p-5">
        <div class="col-md-9">
          <div class="row">
            <div class="col-md-5 mr-auto">
              <h2 class="footer-heading mb-4 font-weight-bold">sobre Nosotros</h2>
        ...
        <div class="col-md-3">
          <img src="img/mama.png" alt="mama">
        </div>
      </div>

    </div>
    <!-- segundo_footer -->
    <div class="col-md-12 segundo_footer">
      <div class="container">
        <p id="fecha">Todos los derechos reservados &copy;<span>2020</span></p> 
      </div>
    </div>
  </footer>
  <!-- Jquery -->
